...
module.exports = {
  ...
  description: "Gửi link mời bot", //the command description for helpcmd [OPTIONAL]
    ...
    try {
      message.reply({
        embeds: [
          ...
          .setDescription(`[**Ấn Vào đây để mời tôi!**](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot%20applications.commands)\n\n||[**Click here to invite me __without__ Slash Commands!**](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)||`)
        ]
      });
    } catch (e) {
