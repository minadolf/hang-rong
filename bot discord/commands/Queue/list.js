...
module.exports = {
	...
	description: "Danh sách hàng chờ", //the command description for Slash Command Overview
	cooldown: 10,
			...
			try {
				...
				for (let i = 0; i < theSongs.length; i += 10) {
					...
					const embed = new MessageEmbed()
						...
						.setDescription(`${info}`)
					if (i < 10) {
						embed.setTitle(`📑 **Danh sách ${theSongs.length > 50 ? 50 : theSongs.length} | Danh sách nhạc ${guild.name}**`)
